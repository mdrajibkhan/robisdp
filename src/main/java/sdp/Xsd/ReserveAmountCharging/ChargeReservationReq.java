...
@XmlRootElement(name = "chargeReservationReq", namespace = "http://www.csapi.org/schema/parlayx/payment/reserve_amount_charging/v2_1/local")
public class ChargeReservationReq {
