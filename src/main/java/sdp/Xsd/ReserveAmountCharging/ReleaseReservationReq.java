...
@XmlRootElement(name = "releaseReservationReq", namespace = "http://www.csapi.org/schema/parlayx/payment/reserve_amount_charging/v2_1/local")
public class ReleaseReservationReq {
