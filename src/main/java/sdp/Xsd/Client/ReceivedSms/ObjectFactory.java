 ...
 * generated in the sdp.Xsd.Client.ReceivedSms package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: sdp.Xsd.Client.ReceivedSms
     * 
     */
