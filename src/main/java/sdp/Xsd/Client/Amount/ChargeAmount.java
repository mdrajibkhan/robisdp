 ...
 *         &lt;element name="charge" type="{http://www.csapi.org/schema/parlayx/payment/amount_charging/v2_1/local}charge"/>
...
@XmlRootElement(name = "chargeAmount", namespace = "http://www.csapi.org/schema/parlayx/payment/amount_charging/v2_1/local")
public class ChargeAmount {

    @XmlElement(namespace = "http://www.csapi.org/schema/parlayx/payment/amount_charging/v2_1/local", required = true)
